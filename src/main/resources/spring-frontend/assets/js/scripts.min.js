    ...
    $(function () {
                    ...
                    $('.form_search').on('submit', function (e) {
                        ...
                        if (pageSearch) {
                            function getData(address, data) {
                                ...
                                offset: 0, limit: $this.data('searchlimit')
                            });
                        } else {
                        ...
                        switch (data) {
                            ...
                            case'popular':
                                getData('/books/popular', {
                                    offset: $this.data('refreshoffset'), limit: $this.data('refreshlimit')
                                });
                                break;
                            case'genre':
                    ...
                    $('.Comments-addComment form').on('submit', function (e) {
                        ...
                        if (!error) {
                            Login().postData('/bookReview', {
                                bookId: $this.data('bookid'), text: $this.find('.Comments-review').val()
                            }, function (result) {
                                if (result.result) {
        ...
        var Login = function () {
            ...
            function postData(address, data, cb, cbErr) {
                $.ajax({
                    url: address, type: 'POST', dataType: 'json', data: data, complete: function (result) {
                        if (result.status === 200) {
                                ...
                                postData('/approveContact', $this.data('send'), function (result) {
                                    if (result.result) {
                                        $LoginStep.find('[data-send]').data('send', {
                                            code: code, contact: send.contact
                                        });
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            Login().postData('/books/changeBookStatus/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'), status: 'PAID'
                            }, function (result) {
                            ...
                            Login().postData('/books/changeBookStatus/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'), status: status
                            }, function (result) {
                                if (result.result) {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/rateBook', {
                            bookId: $this.closest('.Rating').data('bookid'), value: (check ? $this.val() : 0)
                        }, function (result) {
                    ...
                    $containerCar.each(function () {
                        ...
                        if ($this.hasClass('Cards')) {
                            $this.slick({
                                ...
                                mobileFirst: true,
                                responsive: [{
                                    breakpoint: 990, settings: {slidesToShow: 5, slidesToScroll: 1}
