...
public class AuthUserController {
    ...
    private final BookstoreUserRegisterService registrationService;

    @Autowired
    public AuthUserController(BookstoreUserDetailService bookStoreUserDetailService, BookstoreUserRegisterService registrationService) {
